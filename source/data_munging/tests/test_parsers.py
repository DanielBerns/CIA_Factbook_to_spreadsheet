...
class ParsersTestCase(unittest.TestCase):
    ...
    def setUp(self):
        print('\n')
        logger = actions.logs.start_logs('test_parsers', 'alpha', 'tests/test_parsers.py')
        actions.parsers.Parser.logger = logger
    ...
    def test_parse_html(self):
        ...
        with actions.processors.create_report(self.experiment, self.version, 'test_parse_html.md') as target:
    ...
    def test_source(self):
        with actions.processors.create_report(self.experiment, self.version, 'test_source.md') as target:
